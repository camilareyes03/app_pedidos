...
<form action="{{ route('ubicaciones.store', $cliente_id) }}" method="POST">
        ...
        <div class="mapform">
            <div class="row">
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="latitud" name="latitud" placeholder="Latitud" value="{{ old('latitud') }}">
                    @error('latitud')
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="longitud" name="longitud" placeholder="Longitud" value="{{ old('longitud') }}">
                    @error('longitud')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" id="referencia" name="referencia" class="form-control" value="{{ old('referencia') }}" tabindex="1">
        @error('referencia')
        <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" id="link" name="link" class="form-control" value="{{ old('link') }}" tabindex="1">
        @error('link')
        <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
